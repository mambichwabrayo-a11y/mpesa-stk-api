export default async function handler(req, res) {
  ...
  if (req.method!== 'POST') return res.status(405).json({ error: 'Use POST only' });【5661122868216343151†L144-L146】
  ...
  try {
    ...
    const response = await fetch('https://backend.payhero.co.ke/api/v2/payments', {
      ...
      body: JSON.stringify({
        ...
        callback_url: 'https://webhook.site/your-unique-url' // Weka yako ama iondoe hii line
      })
    });
